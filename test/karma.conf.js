...
module.exports = function(config) {
  ...
  config.set({
    ...
    files: [
      ...
      'app/bower_components/promise-polyfill/Promise.js',
      'app/bower_components/hydrolysis/hydrolysis.js',
      'app/bower_components/marked/lib/marked.js',
      'app/bower_components/prism/prism.js',
      'app/bower_components/web-animations-js/web-animations.min.js',
      'app/bower_components/page/page.js',
